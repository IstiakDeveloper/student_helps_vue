<template>
    ...
    <div class="flex h-screen overflow-hidden bg-gray-100">
      ...
      >
        <div class="p-4 flex items-center justify-between">
            <Link :href="'/'">
          <h1 class="text-xl font-bold text-gray-800">Srudents Help</h1>
            </Link>
      ...
      <div class="flex-1 flex flex-col lg:ml-64">
        ...
        <header class="fixed top-0 left-0 right-0 lg:left-64 bg-white shadow-md z-20 flex justify-between items-center p-4">
          ...
          <div class="relative">
            ...
            <template v-if="isStudent()">
                <Link href="/student-profile" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Profile</Link>
            </template>
            <template v-else>
        ...
        <main class="flex-1 p-6 mt-16 overflow-auto bg-gray-100">
            <div v-if="!hasActiveSubscription" class="bg-red-600 text-white p-4 text-center">
                Please take a subscription to get support. <Link :href="`/subscriptions`" class="text-blue-300 font-bold underline" >Click Here</Link>
            </div>
          <!-- Center Content -->
          <div class="mx-auto">
            <slot></slot>
  ...
  const { props } = usePage();
  const hasActiveSubscription = props.hasActiveSubscription;
